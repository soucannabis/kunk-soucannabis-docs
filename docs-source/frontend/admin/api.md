...
> Contrato da API do app admin (`apps/admin`).
> Fluxo: [flow.md](./flow.md).
...
### Necessário para o admin (extensões de API)

| Item | Motivo |
|---|---|
| Whitelist completa alinhada ao schema do produto | Browser de dados |
