...
> Contratos da API para Serviços, Profissionais e Google Calendar.
...
Response: lista de serviços (shape de [fields.md](./fields.md)).
...
`calendar_id` já existe no schema.

Normalizar `is_collaborator` / `is_prescriber` para boolean.
