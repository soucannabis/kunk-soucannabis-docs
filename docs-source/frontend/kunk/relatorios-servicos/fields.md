...
| `tags` | Exibição opcional; **sem** bônus por tag no cálculo |
...
Campo `validation` foi removido no alter; o relatório **precisa** dele de volta com nome claro:
...
Campo de contestações: `contest_reports`.
