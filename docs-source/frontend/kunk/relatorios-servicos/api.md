...
Com o módulo de e-mail/SMTP configurado, o mesmo endpoint envia o convite sem mudar o contrato do front (`email_sent` / `email_status` refletem o resultado).
...
## 9. Fora desta área na API

| Item | Disponível aqui? |
|---|---|
| Ação de pagamento externo | Não |
| Mensagem de chat ao contestar | Não |
| Cupons no relatório | Não |
