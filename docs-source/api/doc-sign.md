...
**Sem** Document Server, LibreOffice ou DOCX canônico — PDF gerado na API a partir do JSON TipTap (ver [`../frontend/doc-sign/`](../frontend/doc-sign/README.md)).
...
## Comportamento das rotas `/terms/*`

Aliases de transição (`/terms/*` → `/doc-sign/*`). Sem doc-sign ativo, as respostas usam `TERMS_MODULE_IN_DEVELOPMENT` / 501. Com o módulo ativo, os handlers reais atendem essas rotas.
