...
No o módulo sincroniza/transfere atendentes na triagem e, opcionalmente, envia uma **mensagem automática** quando o formulário público cria um contato.
...
| `utalk_token` em `system_users` | Não usado |
