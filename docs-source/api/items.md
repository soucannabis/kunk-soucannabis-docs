...
Case: **snake_case** do schema do produto (`orders`, `system_users`, …).
...
**204** sem body, ou **200** com `{ "data": { "id": 42 } }` (padrão: **204** para delete simples).

### Criar / atualizar em lote
