...
const github = "https://github.com/soucannabis/kunk-soucannabis";
...
const sidebar = [
  ...
  },
  {
    label: "API",
    items: [
      { label: "Visão geral", slug: "referencia-api" },
      { label: "Catálogo de rotas", slug: "referencia-api/routes-catalog" },
      { label: "Códigos de erro", slug: "referencia-api/error-codes" },
      { label: "Arquitetura", slug: "referencia-api/architecture" },
      { label: "Autenticação", slug: "referencia-api/authentication" },
      { label: "Autorização", slug: "referencia-api/authorization" },
      { label: "Rotas de domínio", slug: "referencia-api/domain-routes" },
      { label: "Items", slug: "referencia-api/items" },
      { label: "Collections", slug: "referencia-api/collections" },
      { label: "Query parameters", slug: "referencia-api/query-parameters" },
      { label: "Arquivos", slug: "referencia-api/files" },
      { label: "Storage cloud", slug: "referencia-api/files-cloud-storage" },
      { label: "Storage S3", slug: "referencia-api/storage-s3-setup" },
      { label: "Storage GCS", slug: "referencia-api/storage-gcs-setup" },
      { label: "Cache", slug: "referencia-api/cache" },
      { label: "Erros", slug: "referencia-api/errors" },
      { label: "System errors", slug: "referencia-api/system-errors" },
      { label: "Web vitals", slug: "referencia-api/web-vitals" },
      { label: "Doc-sign (API)", slug: "referencia-api/doc-sign" },
      { label: "Módulos (índice)", slug: "referencia-api/modules" },
      autoGroup("Módulos", "referencia-api/modules"),
    ],
  },
...
export default defineConfig({
  site: "https://kunksoucannabis.ong.br",
  devToolbar: {
    enabled: false,
  },
  vite: {
