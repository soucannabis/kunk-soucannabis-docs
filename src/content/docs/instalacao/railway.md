...
O template [Deploy Kunk Sou Cannabis Open Source](https://railway.com/deploy/52h9Cj) empacota o stack completo a partir do repositório [`soucannabis/kunk-soucannabis`](https://github.com/soucannabis/kunk-soucannabis):
