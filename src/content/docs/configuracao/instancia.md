...
Há um fluxo de **install** no Admin para bootstrap da instância. Localmente, o seed da API (`npm run seed:sample --prefix kunk-api`) popula dados de exemplo para exploração.
